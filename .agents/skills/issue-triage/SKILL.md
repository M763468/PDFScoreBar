...
1) Run `bash .agents/skills/issue-triage/run.sh` to generate the triage artifact.
...
- `bash .agents/skills/issue-triage/run.sh`: script to fetch and triage issues into `artifacts/`
- gh: to fetch issue data

## Example commands
- `bash .agents/skills/issue-triage/run.sh`
