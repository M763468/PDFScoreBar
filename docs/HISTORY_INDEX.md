...
- `docs/PIPELINE_ARCHITECTURE.md` — current production architecture
- `docs/TWO_HOMR_MILESTONE.md` — accepted #274 / PR #279 comparison milestone
- `docs/DOCUMENTATION_INVENTORY.md` — documentation classification
- `docs/ENVIRONMENTS.md` — maintained execution environments
- `docs/BRANCH_POLICY.md` — branch policy
- `docs/dev/VALIDATION_POLICY.md` — validation policy
- `docs/BARLINE_MATCHER.md` — detector matching/evaluation contract
- `docs/GT_PREPARATION_POLICY.md` — GT policy
...
- `docs/DEVLOG_MEASURE_NUMBERING.md` for early development history only
- `docs/refactors/issue94/**`
- `docs/refactors/issue194/**`
- `docs/refactors/issue201/**`
- current source/tests for present behavior
- #264/#274 records for the accepted geometry-rebased downstream contract

`DEVLOG_MEASURE_NUMBERING.md` is historical/reference material, not the current specification.

### Fresh detector restoration / connector-aware grouping / HOMR support reuse

Primary lineage:

`#245 -> #252/#254/#255 -> #264 -> #274 / PR #279 -> #280`

Start with:

- `docs/PIPELINE_ARCHITECTURE.md`
- `docs/TWO_HOMR_MILESTONE.md`
...
- `docs/refactors/issue226/**`
- `docs/refactors/issue227/**`
- `docs/refactors/issue228/**`
- `docs/refactors/issue229/**`
- `docs/manual_correction_review_package.md`
- `docs/corrected_final_output.md`
