...
- [Issue #141](https://github.com/M763468/PDFScoreBar/issues/141) validated a full-pipeline checkpoint, but this did not prove that arbitrary fresh inputs regenerate the same upstream artifacts without retained historical inputs.
