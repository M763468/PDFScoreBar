...
| User-facing output profile contract | [`docs/refactors/issue227/ISSUE227_OUTPUT_PROFILES.md`](refactors/issue227/ISSUE227_OUTPUT_PROFILES.md) |
...
- **Issue #227 User-facing Output Profile Contract**  
  ...
  for the user-facing pipeline, including final artifact exclusions and
  handoffs to the final overlay and manual correction workflow issues.
