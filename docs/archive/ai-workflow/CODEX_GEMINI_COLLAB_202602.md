# Archived: Codex + gemini-cli collaboration workflow (2026-02)

> Historical record only. This file is not an active agent instruction.
> Preserved from `docs/ai-workflow/CODEX_GEMINI_COLLAB.md` during the 2026-09 agent-guidance cleanup.
