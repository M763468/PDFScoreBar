...
def main():
    ...
    for json_path in tqdm(scored_files):
        ...
        for cand in candidates:
            ...
            if is_matched_gt:
                ...
                gt_matched[best_gt_idx] = (
                    True  # Consumed by at least one candidate (regardless of score)
                )
        ...
        for box in fn_det_boxes:
            ...
            cv2.putText(
                overlay, "Miss", (x1, y1 - 2), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 255), 1
            )
        ...
        for item in fn_cnn_boxes:
            ...
            cv2.putText(
                overlay, f"{score:.2f}", (x1, y1 - 2), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 255), 1
            )
        ...
        for item in fp_boxes:
            ...
            cv2.putText(
                overlay, f"{score:.2f}", (x1, y1 - 2), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 1
            )
