...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--penalty-small", type=float, default=DEFAULT_PENALTY_SMALL, help="Penalty for gap < 4"
    )
    parser.add_argument(
        "--penalty-mid",
        type=float,
        default=DEFAULT_PENALTY_MID,
        help="Penalty for 10 < gap < w_min",
    )
