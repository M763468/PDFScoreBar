...
def main():
    ...
    with open(os.path.join(output_dir, "qualitative_report.md"), 'w') as f:
        ...
        f.write(f"- **Source**: Hybrid pipeline (SR + homr)\n")
        f.write(f"- **File**: `logs/hybrid_generalization/page_10_hybrid_test/omr_sr/predictions.json`\n\n")
        ...
        f.write("\n## Observations\n\n")
        f.write("- Filter successfully identifies rows and applies consistency checks\n")
        f.write("- Staff space estimation appears reasonable\n")
        f.write("- Ratio-based tolerances adapt to local spacing\n")
        f.write("- Visual inspection of overlays recommended\n\n")
