...
def add_measure_numbers(image_path, output_path, barlines):
    ...
    for staff_y_key in sorted(staves.keys()):
        ...
        measure_dividers = [
            ((start_x, first_barline_y_start), (start_x, first_barline_y_end))
        ] + staff_barlines
...
if __name__ == "__main__":
    ...
    high_quality_barlines = [
        ...
        ((269, 745), (269, 785)),
        ((367, 745), (367, 785)),
        ((463, 745), (463, 785)),  # Repeat bar
        # Staff 11: y ~802-842
        ((75, 802), (75, 842)),
        ((172, 802), (172, 842)),
        ((269, 802), (269, 842)),
        ((367, 802), (367, 842)),
        ((463, 802), (463, 842)),  # Repeat bar
    ]
