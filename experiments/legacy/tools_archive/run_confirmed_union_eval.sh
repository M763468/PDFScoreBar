...
# Phase 5b Evaluation of Strategy 1: Confirmed Union
...
OUTPUT_DIR="logs/phase5b_confirmed_union_eval"
...
for PAGE in "${PAGES[@]}"; do
    ...
    # 1. Generate Hybrid Predictions using Confirmed Union
    ./.venv_pdf/bin/python tools/generate_hybrid_results.py \
        ...
        --output "$HYBRID_PREDS" \
        --gt "${GT_MAP[$PAGE]}" \
        --merge-strategy confirmed_union
