...
### references
- get_center() `EXTRACTED`
- get_bbox() `EXTRACTED`
- parse_clefs_keys() `EXTRACTED`
- rm_merge_overlap_bbox() `EXTRACTED`
- parse_rests() `EXTRACTED`
- merge_nearby_bbox() `EXTRACTED`
- filter_out_of_range_bbox() `EXTRACTED`
- get_notehead_bbox() `EXTRACTED`
- filter_barlines() `EXTRACTED`
- find_lines() `EXTRACTED`
- filter_out_small_area() `EXTRACTED`
- gen_rests() `EXTRACTED`
- gen_sfns() `EXTRACTED`
- draw_bounding_boxes() `EXTRACTED`
- filter_notehead_bbox() `EXTRACTED`
- check_bbox_size() `EXTRACTED`
- filter_clef_box() `EXTRACTED`
- gen_clefs() `EXTRACTED`
- get_nearby_note_id() `EXTRACTED`
