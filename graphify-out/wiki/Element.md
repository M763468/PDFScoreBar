...
- **.init_sfn_state()** (4 connections) — `external/oemer/oemer_src/oemer/build_system.py`
...
- **build_part_list()** (3 connections) — `external/oemer/oemer_src/oemer/build_system.py`
- **build_work()** (3 connections) — `external/oemer/oemer_src/oemer/build_system.py`
- **.perform()** (3 connections) — `external/oemer/oemer_src/oemer/build_system.py`
- **decode_backup()** (3 connections) — `external/oemer/oemer_src/oemer/build_system.py`
