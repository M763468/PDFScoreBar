...
- **main()** (5 connections) — `experiments/models/eval_grounding_dino.py`
- **main()** (5 connections) — `tools/debug_greedy_match.py`
- **evaluate_and_visualize.py** (5 connections) — `tools/evaluate_and_visualize.py`
- **eval_grounding_dino.py** (4 connections) — `experiments/models/eval_grounding_dino.py`
...
- **load_gt_boxes()** (2 connections) — `experiments/models/eval_grounding_dino.py`
- **parse_args()** (2 connections) — `experiments/models/eval_grounding_dino.py`
...
- [greedy_barline_match](greedy_barline_match.md) (27 shared connections)
- [metrics.py](metrics.py.md) (14 shared connections)
- [barline_iou](barline_iou.md) (11 shared connections)
...
- `experiments/models/eval_grounding_dino.py`
