...
- stage_summary() `EXTRACTED`
- [main()](main%28%29.md) `EXTRACTED`
- [main()](main%28%29.md) `EXTRACTED`
- get_barline_match_rank() `EXTRACTED`
- _metrics() `EXTRACTED`
- expand_barline_box() `EXTRACTED`
- target_metrics() `EXTRACTED`
- apply_nms() `EXTRACTED`
- nearest_box() `EXTRACTED`
- has_match() `EXTRACTED`
- apply_barline_overrides() `EXTRACTED`
- has_match() `EXTRACTED`
- _best_recoverable_candidate() `EXTRACTED`
- choose_representative() `EXTRACTED`
- cluster_boxes() `EXTRACTED`
- choose_representative() `EXTRACTED`
- choose_representative() `EXTRACTED`
