...
- **has_match()** (3 connections) — `tools/generate_hybrid_results.py`
- **load_json_boxes()** (3 connections) — `tools/generate_hybrid_results.py`
- **offset_boxes()** (3 connections) — `tools/multi_crop_merge.py`
- **scale_boxes()** (3 connections) — `tools/scale_merge_homr_preds.py`
- **load_json_boxes()** (2 connections) — `tools/diagnose_false_negatives.py`
- *... and 5 more nodes in this community*

## Relationships

- [barline_evaluation.py](barline_evaluation.py.md) (10 shared connections)
- [greedy_barline_match](greedy_barline_match.md) (7 shared connections)
- [mine_fn_cnn_hardpositives.py](mine_fn_cnn_hardpositives.py.md) (4 shared connections)
- [edge_crop_homr_merge.py](edge_crop_homr_merge.py.md) (3 shared connections)
