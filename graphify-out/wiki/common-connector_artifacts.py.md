...
- **common/connector_artifacts.py** (18 connections) — `src/common/connector_artifacts.py`
...
- **test_issue274_connector_support_contract.py** (5 connections) — `tests/test_issue274_connector_support_contract.py`
- **_staff_path()** (4 connections) — `tests/test_issue274_connector_support_contract.py`
- **test_numbering_fallback_remains_available_without_declared_current_support()** (4 connections) — `tests/test_issue274_connector_support_contract.py`
- **test_numbering_rejects_missing_pair_inside_declared_current_support()** (4 connections) — `tests/test_issue274_connector_support_contract.py`
- **_sha256()** (3 connections) — `src/common/connector_artifacts.py`
- **_staff_mask_stem()** (3 connections) — `src/common/connector_artifacts.py`
- **Path** (3 connections)
- **Any** (1 connections)
- **Stable connector-semantic artifact contract shared by detection and numbering.** (1 connections) — `src/common/connector_artifacts.py`
- **Return whether every requested HOMR page has a complete semantic pair.** (1 connections) — `src/common/connector_artifacts.py`
- **Remove a previously published pair so stale semantics cannot be reused.** (1 connections) — `src/common/connector_artifacts.py`
