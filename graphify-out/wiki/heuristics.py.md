...
- **heuristics.py** (30 connections) — `src/homr_eval_scripts/core/heuristics.py`
...
- **BarlinePrediction** (7 connections)
- **Path** (7 connections)
...
- **generate_hough_vertical_candidates()** (5 connections) — `src/homr_eval_scripts/core/heuristics.py`
