...
- **Box** (1 connections)
- **Path** (1 connections)
- **Hybrid consensus helpers for in-process detection pipeline.** (1 connections) — `src/pipeline/steps/hybrid_consensus.py`
- **Keep baseline boxes that are supported by SR or OMR predictions.** (1 connections) — `src/pipeline/steps/hybrid_consensus.py`
