...
- **Box** (2 connections)
- **HardNegativeRow** (2 connections) — `tools/cnn_classifier/mine_hard_negatives.py`
- **Box** (1 connections)
- **Parse score/page context from scored JSON path. Supported layouts: - nested:…** (1 connections) — `tools/re_evaluate_global.py`
