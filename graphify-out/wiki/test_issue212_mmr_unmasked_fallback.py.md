...
- **test_fallback_paths_skip_empty_crops_before_preprocessing()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
- **test_left_wide_unmasked_fallback_recovers_positive_score_candidate()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
- **test_left_wide_unmasked_fallback_rejects_negative_score_candidate()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
- **test_left_wide_unmasked_fallback_stays_above_main_threshold()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
- **test_unmasked_current_crop_fallback_recovers_number_when_masked_has_no_candidate()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
- **test_unmasked_fallback_is_not_used_when_masked_path_has_candidate()** (3 connections) — `tests/test_issue212_mmr_unmasked_fallback.py`
