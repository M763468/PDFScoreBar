...
def generate_prompt_with_examples(image_to_analyze_path, ground_truth_path):
    ...
    prompt_parts = [
        ...
        "1. Your primary goal is to find **barlines**. Barlines are thin, vertical lines that stretch across the staff lines to separate measures.",
        "2. You MUST IGNORE all other vertical lines that are not barlines. This includes, but is not limited to:",
        ...
        "3. For each barline you detect, provide its bounding box coordinates in the format `[x_start, y_start, x_end, y_end]`.",
        "4. Return your final output as a single, valid JSON object. This object must have a single key, `\"barlines\"`, which contains a list of the coordinate arrays you found.",
