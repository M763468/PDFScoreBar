...
class SystemBuilder:
    ...
    def build_systems(self, staves: List[Staff], barlines: List[Barline], image: Optional[np.ndarray] = None) -> List[System]:
        """
        Main entry point.
        """
        if not staves:
    ...
    def _check_aligned_connection(self, s1: Staff, s2: Staff, aligned_pairs: List[Tuple[Barline, Barline]], image: np.ndarray) -> bool:
        """
