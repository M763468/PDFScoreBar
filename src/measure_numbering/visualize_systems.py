...
def visualize_systems(image_path: str, json_path: str, output_path: str):
    ...
    for i, system in enumerate(systems):
        ...
        for staff in system.staves:
            ...
            cv2.rectangle(overlay, (int(s_bbox.x1), int(s_bbox.y1)), (int(s_bbox.x2), int(s_bbox.y2)), color, -1)
        ...
        if system.staves:
             ...
             cv2.putText(img, f"Sys {i+1}", (int(sys_x1), int(sys_y1)-5), cv2.FONT_HERSHEY_SIMPLEX, 0.8, color, 2)
