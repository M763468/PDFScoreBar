...
PROBE_SCAN_KWARG_KEYS = (
    ...
    "aligned_expansion_rescue_enabled",
    "aligned_expansion_pad_ratio",
    "aligned_expansion_x_tolerance",
    "aligned_expansion_min_existing_coverage",
    "aligned_expansion_min_height_ratio",
    "aligned_expansion_max_height_ratio",
    "aligned_expansion_preserve_raw",
    "x_merge_tol",
