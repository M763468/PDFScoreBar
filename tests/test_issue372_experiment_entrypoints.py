...
def test_reassess_final_numbering_values_direct_entrypoint_bootstraps_repo(
    tmp_path: Path,
) -> None:
    _assert_direct_help_succeeds(
...
def test_visualize_late_raw_detector_residuals_direct_entrypoint_bootstraps_repo(
    tmp_path: Path,
) -> None:
    _assert_direct_help_succeeds(
...
def test_diagnose_page021_staff_overlap_direct_entrypoint_bootstraps_repo(
    tmp_path: Path,
) -> None:
    _assert_direct_help_succeeds(
