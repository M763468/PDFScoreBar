...
def main():
    ...
    parser.add_argument(
        "--src-root", default="data/evaluation2/annotations_provisional", help="Source directory"
    )
    parser.add_argument(
        "--dst-root", default="data/evaluation2/annotations", help="Destination directory"
    )
    parser.add_argument(
        "--date-suffix", default=None, help="Date suffix for filename (e.g., 20260106)"
    )
