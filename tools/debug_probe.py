...
def main():
    ...
    x2 = min(
        gray.shape[1] - 1, x_center + w_half
    )  # probe_width window (e.g. 4px usually implies index to index+width or center +/- width/2? detect_probe_scan usually uses x-w/2 to x+w/2)
