...
def main():
    parser = argparse.ArgumentParser(description="Extract ROIs for multi-measure rests from numbering JSON and notehead mask.")
    ...
    parser.add_argument("--output-dir", type=Path, required=True, help="Directory to save ROI crops")
