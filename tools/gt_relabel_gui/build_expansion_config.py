...
EXPANSION_PAGES = [
    {
        ...
        "barlines": TRAINING_WS
        / "data/evaluation/annotations/page_003/boxes_sorted_v20260111.json",
        "mask": TRAINING_WS
        / "logs/hybrid_generalization/sr_eval_smoke_page3/baseline/page_3/page_3/page_3_debug_3_staff.png",
    ...
    },
    {
        ...
        "mask": TRAINING_WS
        / "logs/hybrid_generalization/sr_eval_page10_check2/baseline/page_10/page_10/page_10_debug_3_staff.png",
    ...
    },
    {
        ...
        "mask": TRAINING_WS
        / "logs/hybrid_generalization/sr_eval_page15_check2/baseline/page_15/page_15/page_15_debug_3_staff.png",
...
def main():
    ...
    for page in EXPANSION_PAGES:
        ...
        cmd = [
            ...
            str(page["mask"]),
            "--image",
            str(local_img_path),  # Use local image
            "--output-json",
            str(numbering_file),
            "--output-overlay",
            str(page_cache_dir / "debug_overlay.png"),
            "--force-single-system",
        ]
