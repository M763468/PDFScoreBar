...
def draw_errors(work, page, gt_path, pred_path, numbering_path, img_path, out_path):
    ...
    for item in gt:
        ...
        if g_idx in idx_map:
            ...
            if (s_idx, m_idx) in coords:
                ...
                cv2.putText(img, f"GT:{count}", (x1, y1-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    ...
    for item in pred:
        ...
        if (s_idx, m_idx) in coords:
            ...
            cv2.putText(img, f"Pred:{count}", (x1, y2+25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
...
def main():
    # Page 004
    draw_errors("prokofiev5", "page_004",
    ...
    # Page 005
    draw_errors("prokofiev5", "page_005",
