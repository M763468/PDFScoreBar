...
def main() -> int:
    ...
    summary = {
        ...
        "verification_contract": {
            "control_source": (
                "retained detector control accepted barlines are not assumed to contain "
                "numbering outputs"
            ),
            "retained_link": (
        ...
        "supersedes": {
            ...
            "v3_problem": (
                "fixed the fresh per-page path but retained the same nonexistent control-numbering assumption"
            ),
