...
EXPECTED_IMAGE_ID="${ISSUE294_EXPECTED_IMAGE_ID:-sha256:80573e47bc87db82f4773a0a51fc3b1901012f7b0138a67a7c1d8ab1518a988c}"
CONTAINER_IMAGE="${ISSUE294_CONTAINER_IMAGE:-$EXPECTED_IMAGE_ID}"
REQUIRED_DEVELOP="3ae4b710076cd7f4d7e0aa2a1270817d4f3d77b2"
