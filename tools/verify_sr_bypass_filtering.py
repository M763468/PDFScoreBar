...
def main():
    ...
    baseline_run_root = PROJECT_ROOT / "logs/hybrid_generalization/bypass_sr_test/eval2_bypass_sr_test_v2/baseline/batch/page_001"
    ...
    result_json = output_root / "probe_scan/eval2_Va_Prokofiev_Symphony1_page_001/pipeline2_no_peak_filtered_cnn.json"
