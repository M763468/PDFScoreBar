...
def main():
    ...
    image_path = (
        PROJECT_ROOT / "data/evaluation2/images/Sibelius-Violin_Concerto-Viola/page_001.png"
    )
    gt_path = (
        PROJECT_ROOT
        / "data/evaluation2/annotations/Sibelius-Violin_Concerto-Viola/page_001/boxes_sorted.json"
    )

    # We use the existing baseline results as the starting point (FPs included)
    baseline_root = (
        PROJECT_ROOT
        / "logs/hybrid_pipeline_bench/eval2_Sibelius-Violin_Concerto-Viola_page_001_20260131_094551/baseline"
    )
    ...
    shutil.copy(baseline_root / "page_001/page_001/page_001_proxy_debug_3_staff.png", temp_mask)
    ...
    result_json = (
        output_root / "probe_scan/eval2_test_run_page_001/pipeline2_no_peak_filtered_cnn.json"
    )
